...
public class UserCountController {
    ...
    public Response<FindUserCountsByIdRspDTO> findUserCountData(@Validated @RequestBody com.school.xiaohashu.count.dto.FindUserCountsByIdReqDTO findUserCountsByIdReqDTO) {
