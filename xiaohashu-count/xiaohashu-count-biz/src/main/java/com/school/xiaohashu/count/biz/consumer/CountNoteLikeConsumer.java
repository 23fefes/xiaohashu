...
import com.school.xiaohashu.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.school.xiaohashu.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
public class CountNoteLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        log.info("## 【笔记点赞数】聚合后的计数数据: {}", JsonUtils.toJsonString(countMap));// 更新 Redis
