...
import com.school.xiaohashu.count.biz.domain.dataobject.NoteCountDO;
...
public class NoteCountServiceImpl implements NoteCountService {
     ...
     */
    @Override
    public Response<List<FindNoteCountsByIdRspDTO>> findNotesCountData(com.school.xiaohashu.count.dto.FindNoteCountsByIdsReqDTO findNoteCountsByIdsReqDTO) {
        // 需要查询的笔记 ID 集合
