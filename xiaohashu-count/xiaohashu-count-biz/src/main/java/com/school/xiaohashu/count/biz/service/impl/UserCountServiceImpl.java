package com.school.xiaohashu.count.biz.service.impl;
...
import com.school.xiaohashu.count.biz.domain.dataobject.UserCountDO;
import com.school.xiaohashu.count.biz.domain.mapper.UserCountDOMapper;
import com.school.xiaohashu.count.biz.service.UserCountService;
...
public class UserCountServiceImpl implements UserCountService {
     ...
     */
    @Override
    public Response<com.school.xiaohashu.count.dto.FindUserCountsByIdRspDTO> findUserCountData(com.school.xiaohashu.count.dto.FindUserCountsByIdReqDTO findUserCountsByIdReqDTO) {
        // 目标用户 ID
        Long userId = findUserCountsByIdReqDTO.getUserId();

        com.school.xiaohashu.count.dto.FindUserCountsByIdRspDTO findUserCountByIdRspDTO = com.school.xiaohashu.count.dto.FindUserCountsByIdRspDTO.builder()
                .userId(userId)
                .build();
